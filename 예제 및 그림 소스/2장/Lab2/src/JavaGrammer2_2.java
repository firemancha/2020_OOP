...
public class JavaGrammer2_2 {
	...
	// (실습2-2) 아래의 조건에 맞게 문장들을 완성한다.
		...
		System.out.println("(1번답) 안녕은 \'Hello\\Hi\'라고 해!");
		System.out.println("\n-----------------------------------------------\n");
		...
		int minute = time%60; 	// 60으로 나눈 나머지는 분
		int hour = (time/60)%24; 		// 60으로 나눈 몫을 다시 24로 나눈 나머지는 시간
		int day = (time/60)/24; 		// 60으로 나눈 몫을 다시 24로 나눈 몫은 일
